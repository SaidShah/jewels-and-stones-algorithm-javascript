...
let numjewelsewelsInstonestones = function(jewels, stones) {
    let counter = 0;
    stones.split("").map(eachItem=>{
        if(jewels.includes(eachItem)){counter++}
    })
    return counter
};

console.log(numjewelsewelsInstonestones(jewels,stones))
